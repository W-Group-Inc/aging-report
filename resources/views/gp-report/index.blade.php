                                ...
                                <table id='table' class="table table-striped table-bordered table-hover fullSummaryTable" style="margin-bottom: 0px !important;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @endphp
                                            {{number_format(((($invoice->ap_whi)->whereIn('chart_of_account.FatherNum',['710400','710700'])->sum('LineTotal') / $invoices->where('U_InvoiceNo',$invoice->U_InvoiceNo)->sum('VOLUME')) * $invoice->VOLUME),2)}}
