...
<head>
    ...
    <style>
        ...
        .customer-container .left-column .info-label{
            width: 7%; /* Fixed width for labels */
    ...
    <table>
        ...
        <tbody>
            ...
            @foreach ($detail->PbiCreditNoteBody as $item)
                <tr>
                    <td style="width: 7.5%;">{{ $item->list_no }}</td>
                    <td style="width: 10%;">{{ $item->quantity }}</td>
                    <td style="width: 7%;">{{ $item->unit }}</td>
                    <td style="width: 49.5%;">{{ $item->description }}</td>
                    <td style="width: 11.5%;">{{ $item->unit_price }}</td>
                    <td style="width: 13.5%;">{{ $item->currency }} {{ $item->total !== null ? number_format($item->total, 2) : '' }}</td>
                </tr>
                @php
            ...
            @for ($i = count($detail->PbiCreditNoteBody); $i < 10; $i++)
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
            ...
            <tr >
                ...
                <td><strong></strong></td>
                <td></td>
                <td style="padding-top: 3px !important;"><strong>{{ $detail->PbiCreditNoteBody->first()->currency }} {{ number_format($grandTotal, 2) }}</strong></td>
            </tr>
        </tbody>              
    </table>
</div>
