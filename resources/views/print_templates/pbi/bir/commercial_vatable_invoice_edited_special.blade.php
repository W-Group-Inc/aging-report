              ...
              @endphp
                  <tr style="line-height: 10px">
                      ...
                      <td style="width: 100px;">
                            {{ !empty($product->Quantity) && $product->Quantity != 0 ? number_format($product->Quantity, 2) : '' }}
                      </td>
                      <td style="width: 77px;">
                  ...
                  <tr>
                    ...
                    <td style="width: 103px; padding-bottom:0; border-bottom: 1px solid black; border-top: 1px solid black;text-align: right">{{ number_format($total_amount_payable,2) }}</td>
                  </tr>
                  ...
                  <tr>
                    <td></td>
                    <td style="width: 289px; text-align:left;padding-left: 20px; box-sizing: border-box;">{!! nl2br(e(optional($details->first())->Remarks )) !!}</td>
                    <td></td>
                    <td></td>
                    <td ></td>
                  </tr>
