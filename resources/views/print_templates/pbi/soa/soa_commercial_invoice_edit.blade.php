<div class="modal fade" id="soaCommercialEditPbi{{ $detail->DocEntry }}" tabindex="-1" aria-labelledby="soaCommercialEditLabel" aria-hidden="true">
    <form method="POST" id="pbiBirCommercial" action="{{ url('whi_soa_save_as_new') }}" autocomplete="off">
      @csrf
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="SOACommercialEditLabel">PBI SOA Commercial Invoice</h5>
          ...
          <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <label >Ship To:</label>
                    <textarea name="DeliveryAddress" rows="3" class="form-control" type="text">{{ $detail->ShipToCode }} {{ $detail->Shiptoaddress}}</textarea>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input name="InvoiceDueDate" class="form-control" type="date" value="{{ optional($detail)->U_SOADueDate ? \Carbon\Carbon::parse(optional($detail)->U_SOADueDate)->format('Y-m-d') : '' }}">
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <label>SO #</label>
                    <input name="SoNo" class="form-control" type="text" value="{{ $detail->DocNum }}">
                </div>
                <div class="col-md-4">
                    <label>DR #</label>
                    <input name="DrNo" class="form-control" type="text">
                </div>
                <div class="col-md-3">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <input name="PlaceOfLoading" class="form-control" type="text" value="{{ $detail->U_PlaceLoading }}">
                </div>
                <div class="col-md-3">
