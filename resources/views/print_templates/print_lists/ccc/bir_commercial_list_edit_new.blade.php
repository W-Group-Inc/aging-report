@if ( $detail->asNew)
<div class="modal fade" id="CccBirCommercialEditNew{{  $detail->asNew->id }}" tabindex="-1" aria-labelledby="birCommercialEditLabel" aria-hidden="true">
    <form method="POST" id="birCommercial" action="{{ url('edit_new_invoice_ccc/' . $detail->asNew->id) }}" autocomplete="off">
      @csrf
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
                    <label >Date:</label>
                    <input name="invoice_date" class="form-control" type="date" value="{{  $detail->asNew->invoice_date }}">
                </div>
                <div class="col-md-12">
                    <label >Sold To:</label>
            ...
            <div class="col-md-12">
                <input name="product_id[]" class="form-control" type="" value="{{  $product->id }}">
            </div>
            <div class="col-md-12">
            ...
            <div class="row" style="margin-top: 20px">
                ...
                <div class="col-md-6">
                    ...
                    <input name="DateOfShipment" class="form-control" type="date" value="{{ \Carbon\Carbon::parse($detail->asNew->DateOfShipment)->format('Y-m-d') }}">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input name="FedderVesssel" class="form-control" type="text" value="{{ $detail->asNew->FedderVessel }}">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input name="TermOfPayment" class="form-control" type="text" value="{{ $detail->asNew->TermsOfPayment }}">
                </div>
                <div class="col-md-6">
                    <label>Invoice Due Date</label>
                    <input name="InvoiceDueDate" class="form-control" type="date" value="{{ \Carbon\Carbon::parse($detail->asNew->InvoiceDueDate)->format('Y-m-d')}}">
                </div>
            </div>           
          </div>
