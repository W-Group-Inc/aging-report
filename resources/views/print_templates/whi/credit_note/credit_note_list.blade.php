                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form method="GET" action="{{ url('credit_note') }}" class="form-inline" style="margin-bottom: 15px;">
                                        ...
                                        <tr>
                                            <td>
                                                @if ($detail->NewCreditNote)
                                                    ...
                                                    @include('print_templates.whi.credit_note.new_credit_note_edit')
                                                    <a target='_blank' href="{{ url('credit_note_internal', $detail->NewCreditNote->id) }}" class="btn btn-warning btn-outline" > <i class="fa fa-sharp fa-print"></i></a>
                                                    <a target='_blank' href="{{ url('credit_note_bir', $detail->NewCreditNote->id) }}" class="btn btn-danger btn-outline" > <i class="fa fa-sharp fa-print"></i></a>
                                                @else
                                                    ...
                                                    @include('print_templates.whi.credit_note.new_credit_note')
                                                @endif
