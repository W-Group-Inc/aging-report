 <!-- Modal Structure -->
 <div class="modal fade" id="soaPhpModal" tabindex="-1" aria-labelledby="soaModalLabel" aria-hidden="true">
    <form method="POST" id="remarksForm" action="{{ url('soa_php_commercial') }}" target="_blank" autocomplete="off">
      @csrf
