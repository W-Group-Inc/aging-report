 <!-- Modal Structure -->
 <div class="modal fade" id="soaUsaModal" tabindex="-1" aria-labelledby="soaModalLabel" aria-hidden="true">
  <form method="POST" id="remarksForm" action="{{ url('soa_usa_commercial') }}" target="_blank" autocomplete="off">
    @csrf
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="soaModalLabel">SOA USA Commercial Invoice</h5>
