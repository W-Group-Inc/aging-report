 <!-- Modal Structure -->
 <div class="modal fade" id="soaPbiPhpModal" tabindex="-1" aria-labelledby="soaModalLabel" aria-hidden="true">
    <form method="POST" id="remarksForm" action="{{ url('soa_php_commercial_pbi') }}" target="_blank" autocomplete="off">
      @csrf
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="soaModalLabel">SOA PHP Commercial Invoice</h5>
