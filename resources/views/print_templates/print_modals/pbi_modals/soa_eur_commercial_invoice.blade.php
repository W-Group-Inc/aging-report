 <!-- Modal Structure -->
 <div class="modal fade" id="soaPbiEurModal" tabindex="-1" aria-labelledby="soaModalLabel" aria-hidden="true">
    <form method="POST" id="remarksForm" action="{{ url('soa_eur_commercial_pbi') }}" target="_blank" autocomplete="off">
      @csrf
