                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    <a href="#table"><h3 class="no-margins bg-primary p-xs b-r-sm "   onclick='current("current");' >Current : <span id='total_current'>0</span>   <div class="stat-percent font-bold text-white" >&#8369; <span id='current_php'>0.00</span></div></h3><br>
                                      </a> <br>
